...
var InputMask = /*#__PURE__*/function (_Component) {
  ...
  _createClass(InputMask, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var isValueUpdated = prevProps.value !== this.props.value && (this.props.unmask ? this.props.value !== this.getUnmaskedValue() : this.props.value.length && this.input.value !== this.props.value);
